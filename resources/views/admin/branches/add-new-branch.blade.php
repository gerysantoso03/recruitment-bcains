...
@section('content')
    <main class="p-8 flex items-center justify-center">
        <div class="flex flex-col min-w-[90rem] max-w-[120rem] gap-4">
            ...
            {{-- Job Form --}}
            <form action="{{ route('add.branch') }}" method="post" class="border-2 border-sky-900 rounded-lg flex flex-col gap-4 p-4">
                @csrf
                {{-- First Section --}}
                <div class="flex justify-start items-center gap-8">
                    ...
                    <div class="flex flex-col gap-1 flex-1">
                        ...
                        <input type="text" class="border border-sky-900 rounded-lg p-3" name="branch_name">
                ...
                <div class="flex justify-start items-center gap-8">
                    ...
                    <div class="flex flex-col gap-1 flex-1">
                        ...
                        <input type="text" class="border border-sky-900 rounded-lg p-3" name="branch_head">
                    ...
                    <div class="flex flex-col gap-1 flex-1">
                        ...
                        <input type="text" class="border border-sky-900 rounded-lg p-3" name="branch_location">
